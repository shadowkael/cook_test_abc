...
as test. This android application have a simple log-in interface, using that user can log-in and checking server response, credential is right or wrong. This is a basic,importance part of an big application that is why I decide to demonstrate this.